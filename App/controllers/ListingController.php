...
class ListingController
{
  ...
  public function destroy($params)
  {
    ...
    // make DELETE in database if $listing exists
  ...
  public function search()
  {
    ...
    $query =
      'SELECT * FROM listings WHERE (title LIKE :keywords OR description LIKE :keywords OR salary LIKE :keywords OR tags LIKE :keywords OR requirements LIKE :keywords OR benefits LIKE :keywords OR company LIKE :keywords OR address LIKE :keywords OR phone LIKE :keywords OR email LIKE :keywords) AND (city LIKE :location OR state LIKE :location)';
